...
public class ManagedBean {
    ...
    styleNo=headerVo.getCurrentRow().getAttribute("StyleNo").toString().trim();
        ...
        System.out.println("999999999999999999=================== styleNo ==================="+styleNo);
...
public void productionCalculation() {
    ...
    try {
    unit = findViewObject.getCurrentRow().getAttribute("LcUnit").toString();
...
//  System.out.println("=============Dry rows.length================"+rows.length);
 ...
 //   System.out.println("---------- step-4-- Dry -------  Total -------------------"+total);
   ...
   //     System.out.println("=============Wet rows.length================"+rows.length);
    ...
    System.out.println("---------- step-4 -------Wet  Total -------------------"+total);
    return total;
    ...
    ;
     ...
     System.out.println("wash-----------------with date------------------price is"+date);
    ...
    System.out.println("value-----------------with value------------------price is"+value);
    return value;
    }
...
//        System.out.println("=====================fobWitcommVal===================->"+fobWitcommVal);
    ...
    //end of if condition
    System.out.println("-------unitId ------ unitId ----------------------->"+unitId);
    System.out.println("-------FactoryAvgEff ------ creation date is ----------------------->"+date);
    double srno = 0;
...
//    System.out.println("=======addChrgLCVal======="+addChrgLCVal);
    ...
    +addPriceFOBVal);
    System.out.println("================= finalUnitPriceVal ================"+finalUnitPriceVal);
    //if (finalUnitPriceVal > 0)
    finalUnitPrice.setValue(MyMath.toNumber(MyMath.roundTo4(finalUnitPriceVal)));
    
    System.out.println("================= MyMath.toNumber(MyMath.roundTo4(finalUnitPriceVal)) ================"+MyMath.toNumber(MyMath.roundTo4(finalUnitPriceVal)));
...
//    System.out.println("================= wasteInQtyVal ================"+wasteInQtyVal);
    ...
    System.out.println("=============== consWithWasteVal =============="+consWithWasteVal);
...
//        System.out.println("==========getSlectedFobID() ========="+getSlectedFobID().toString());
  ...
  //  System.out.println("--------------------inside for loop---------------------------"+row.getAttribute("MultiSelect"));
    ...
    PreparedStatement createStatement= appM.getDBTransaction().createPreparedStatement(query,0);
    ...
    ViewObject vo = appM.getXX_OM_POC_D1_TVO1(); // in which you wants to populate daa
    ...
    ViewObject vo = appM.getXX_OM_POC_D2_TVO1(); // in which you wants to populate daa
    removeData(vo);
    ...
    public String sendForApproval() {
        // Add event code here...
        refershButton();
        System.out.println("=========== Sent For Approval ==========="+getPocId().getValue());
